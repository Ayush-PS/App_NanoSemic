    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.content}>
          ...
          <Link onPress={logout} style={styles.logoutButton} href=".././sign-up">
